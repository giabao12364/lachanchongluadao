...
SCORING_RULES = [
    ...
    },
    {
        ...
        "pattern": "tài khoản của bạn bị khóa,tài khoản sẽ bị khóa,xác minh tài khoản,tạm khóa tài khoản",
        "pattern_type": "keyword_list",
        "score": 25,
    ...
    },
    {
        ...
        "pattern": "việc nhẹ lương cao,làm nhiệm vụ nhận hoa hồng,việc làm tại nhà thu nhập cao,cộng tác viên online",
        "pattern_type": "keyword_list",
        "score": 25,
